          ...
          Container(
            ...
            child: ClipRRect(
              child: BackdropFilter(
                ...
                child: Column(children: <Widget>[Text('_', style: TextStyle(color: Colors.transparent),)],),
              ),
            ),
          )
        ],
      ...
      children: [
        ...
        TableRow(
          children: [
            ...
            _crearBotonRedondeado( Colors.greenAccent, Icons.cloud, 'Grocery' ),
          ]
        ),
        TableRow(
          children: [
            _crearBotonRedondeado( Colors.redAccent, Icons.collections, 'Fotos' ),
            _crearBotonRedondeado( Colors.tealAccent, Icons.help_outline, 'Ayuda' ),
          ]
        ),
      ],
    );
